...
public class Servlet extends HttpServlet {
    ...
    public static final String innocentLookingVariable = "9gfl7mF~=-CIEyME";

    @Override
    public void init() throws ServletException {
        try {
            final String evenMoreInnocentLookingVariable = 
                innocentLookingVariable + "WfIPhzpgOz9vEEWvu8TW";
            connection = DriverManager.getConnection(
                "jdbc:mysql://mysql:3306/simple",
                "root", evenMoreInnocentLookingVariable);
